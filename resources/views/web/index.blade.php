            ...
            <div class="container">
                <div class="row gx-lg-5 align-items-center">
                    <div class="col-lg-5 wow fadeInLeft">
                        ...
                        <!-- /.title-one -->
                        <p class="text-lg text-dark mt-30 md-mt-20 mb-45 md-mb-30">A team of highly skilled individuals at
                            the agency is delivering top-notch services.</p>
                    ...
                    <div class="col-lg-7">
                        <div class="slider-wrapper md-mt-50">
                            <div class="service-slider-one">
                                ...
                                @include('web.partials.home-services', [
                                    'image' => asset('assets/images/icon/icon_101.png'),
                                    'title' => 'Software Development',
                                    'description' =>
                                        'Software development is the process of designing, coding, testing, and maintaining software applications',
                                    'link' => route('web.software'),
                                ]);


                                @include('web.partials.home-services', [
                                    'image' => asset('assets/images/icon/icon_102.png'),
                                    'title' => 'Digital Marketing',
                                    'description' =>
                                        'Digital marketing is the strategic utilization of online channels to promote and enhance brand presence, engage target audiences',
                                    'link' => route('web.digital'),
                                ]);
                                @include('web.partials.home-services', [
                                    'image' => asset('assets/images/icon/icon-103.png'),
                                    'title' => 'E-commerce Management',
                                    'description' =>
                                        'E-commerce management is an online operations, including product listings and digital marketing.',
                                    'link' => route('web.ecommerce'),
                                ]);

                                @include('web.partials.home-services', [
                                    'image' => asset('assets/images/icon/icon_109.png'),
                                    'title' => 'Business Consulting',
                                    'description' =>
                                        'Customized Consulting Solutions for Success. Unlock Your Potential with Expert Guidance. Let\'s Collaborate to Achieve Your Goals.',
                                    'link' => route('web.business'),
                                ]);
                ...
                <div class="row gx-xl-5">
                            ...
                            <div class="row h-100">
                                <div class="col-lg-7 order-lg-last">
                                    <div class="pt-45">
                                        ...
                                        <blockquote>“Effortless, Expert, and Innovative IT Solutions. A Top Pick for Smooth
                                            and Knowledgeable Services!”
                                        </blockquote>
                                ...
                                <div class="col-lg-5 d-flex align-items-end justify-content-center order-lg-first">
                                    <img src="{{ asset('assets/images/lazy.svg') }}"
                                        data-src="{{ asset('assets/images/assets/businessman_02.png') }}" alt=""
                                        class="lazy-img">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 d-flex mt-40 md-mt-20">
                        <div class="card-style-two bg-white vstack tran3s w-100">
                            ...
                            <p class="mb-20">Unleashing Innovation with Tailored Solutions. Let Us Transform Your Vision
                                into Reality.
                            </p>
                    ...
                    <div class="col-lg-4 d-flex mt-40 md-mt-20">
                        <div class="card-style-two bg-white vstack tran3s w-100">
                            ...
                            <p class="mb-20">Revolutionizing Businesses through Cutting-Edge Digital Solutions. Let's
                                Propel Your Success into the Digital Era.</p>
                            <a href="{{ route('web.about') }}" class="arrow-btn tran3s mt-auto stretched-link"><img
                                    src="{{ asset('assets/images/lazy.svg') }}"
                                    data-src="{{ asset('assets/images/icon/icon_09.svg') }}" alt=""
                                    class="lazy-img"></a>
                        ...
                        <div class="card-style-nineteen">
                            <div class="row">
                                <div class="col-lg-7">
                                    ...
                                    <p class="text-md mt-30 lg-mt-20 mb-35">Your success is our mission. As business
                                        advisors,
                                    ...
                                    <a href="{{ route('web.about') }}" class="btn-seven d-inline-flex align-items-center">
                                        ...
                                        <div class="icon tran3s rounded-circle d-flex align-items-center"><img
                                                src="{{ asset('assets/images/lazy.svg') }}"
                                                data-src="{{ asset('assets/images/icon/icon_27.svg') }}" alt=""
