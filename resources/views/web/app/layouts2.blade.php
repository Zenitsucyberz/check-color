...
<!-- Mirrored from html.creativegigstf.com/check web digitals/check web digitals/service-v1.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Feb 2024 05:53:24 GMT -->

<head>
    <meta charset="UTF-8">
    <meta name="keywords" content="Digital marketing agency, Digital marketing company, Digital marketing services">
    <meta name="description" content="check web digitals is a beautiful website template designed for Business & Consulting websites.">
    <meta property="og:site_name" content="check web digitals">
    <meta property="og:url" content="https://creativegigstf.com/">
    <meta property="og:type" content="website">
    <meta property="og:title" content="check web digitals ">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="logo order-lg-0">
                            <a href="index.html" class="d-flex align-items-center">
                                <img src="{{ asset('assets/images/logo/logo_06.png') }}" alt="" style="max-height: 60px">
                            </a>
                        </div>
                        <!-- logo -->
                        {{--  --}}
                                ...
                                <ul class="navbar-nav align-items-lg-center">
                                    <li class="d-block d-lg-none">
                                        <div class="logo"><a href="index.html" class="d-block"><img
                                                    src="{{ asset('assets/images/logo/logo_01.svg') }}"
                                                    alt=""></a></div>
                                    </li>
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="{{route('web.ecommerce')}}" class="dropdown-item"><span>E-Commerce</span></a></li>
                                            <li><a href="{{route('web.software')}}" class="dropdown-item"><span>Software Development</span></a></li>
                                            <li><a href="{{route('web.digital')}}" class="dropdown-item"><span>Digital Marketing</span></a></li>
                                            <li><a href="{{route('web.business')}}" class="dropdown-item"><span>Business Consulting</span></a></li>
                    ...
                    <div class="col-lg-4 col-md-3">
                        <a href="{{ route('web.contactus') }}"
                            ...
                            <img src="{{ asset('assets/images/lazy.svg') }}"
                                data-src="{{ asset('assets/images/icon/icon_30.svg') }}" alt=""
                                class="lazy-img">
                        </a>
                    </div>
                </div>
        ...
        <div class="footer-three">
            <div class="container">
                <div class="inner-wrapper position-relative">
                    ...
                    <img src="{{ asset('assets/images/lazy.svg') }}"
                        data-src="{{ asset('assets/images/shape/shape_38.svg') }}" alt=""
                        class="lazy-img shapes shape_01">
                    <img src="{{ asset('assets/images/lazy.svg') }}"
                        data-src="{{ asset('assets/images/shape/shape_39.svg') }}" alt=""
